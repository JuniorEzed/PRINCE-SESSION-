    ...
    let num = req.query.number;
     ...
     try {
            ...
            Pair_Code_By_Prince_Junior_Tech.ev.on("connection.update", async (s) => {
               ...
               let session = await Pair_Code_By_Prince_Junior_Tech.sendMessage(Pair_Code_By_Prince_Junior_Techuser.id, { text: '' + b64data });

               let PRINCE_JUNIOR_V1_TEXT = `
*_Pair Code Connected by PRINCE JUNIOR V1*
*_Made With 🤍_*
...
╔═════◇
║  『••• 𝗩𝗶𝘀𝗶𝘁 𝗙𝗼𝗿 𝗛𝗲𝗹𝗽 •••』
║❒ *Ytube:* _youtube.com/sitech1_
║❒ *Owner:* _https://wa.me/254723245807_
║❒ *Repo:* _https://github.com/JuniorEzed/prince-junior
║❒ *WaGroup:* _https://chat.whatsapp.com/LLx80jCw3fsDm94T3hePE7
║❒ *WaChannel:* _https://whatsapp.com/channel/0029Vb5U5AI3wtb8r6Gbex2p
║❒ *Plugins:* _https://github.com/wasixd/WD-PLUGINS_
╚════════════════════════╝
_____________________________________

_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Prince_Junior_Tech.sendMessage(Pair_Code_By_Prince_Junior_Tech.user.id,{text:GIFTED_MD_TEXT},{quoted:session})
